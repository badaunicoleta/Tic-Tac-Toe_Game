...
public class MainWindow extends JFrame{
    ...
    public void initComponents() {
        ...
        Color myBack2 = new Color(65, 105, 225);
        ...
        p11.addActionListener(actionEvent -> {
            p11.setFont(new Font("Times", Font.BOLD, 36));
            if (MainWindow.turn % 2 == 0) p1.setX(p11); //Player 1 turn
            if (MainWindow.turn % 2 != 0) p2.set0(p11); //Player 2 turn
            turn++; // switch turn
        ...
        p12.addActionListener(actionEvent -> {
            p12.setFont(new Font("Times", Font.BOLD, 36));
            if (MainWindow.turn % 2 == 0) p1.setX(p12); //Player 1 turn
            if (MainWindow.turn % 2 != 0) p2.set0(p12); //Player 2 turn
            turn++; // switch turn
        ...
        p13.addActionListener(actionEvent -> {
            p13.setFont(new Font("Times", Font.BOLD, 36));
            if (MainWindow.turn % 2 == 0) p1.setX(p13); //Player 1 turn
            if (MainWindow.turn % 2 != 0) p2.set0(p13); //Player 2 turn
            turn++; // switch turn
        ...
        p21.addActionListener(actionEvent -> {
            p21.setFont(new Font("Times", Font.BOLD, 36));
            if (MainWindow.turn % 2 == 0) p1.setX(p21); //Player 1 turn
            if (MainWindow.turn % 2 != 0) p2.set0(p21); //Player 2 turn
            turn++; // switch turn
        ...
        p22.addActionListener(actionEvent -> {
            p22.setFont(new Font("Times", Font.BOLD, 36));
            if (MainWindow.turn % 2 == 0) p1.setX(p22); //Player 1 turn
            if (MainWindow.turn % 2 != 0) p2.set0(p22); //Player 2 turn
            turn++; // switch turn
        ...
        p23.addActionListener(actionEvent -> {
            p23.setFont(new Font("Times", Font.BOLD, 36));
            if (MainWindow.turn % 2 == 0) p1.setX(p23); //Player 1 turn
            if (MainWindow.turn % 2 != 0) p2.set0(p23); //Player 2 turn
            turn++; // switch turn
        ...
        p31.addActionListener(actionEvent -> {
            p31.setFont(new Font("Times", Font.BOLD, 36));
            if (MainWindow.turn % 2 == 0) p1.setX(p31); //Player 1 turn
            if (MainWindow.turn % 2 != 0) p2.set0(p31); //Player 2 turn
            turn++; // switch turn
        ...
        p32.addActionListener(actionEvent -> {
            p32.setFont(new Font("Times", Font.BOLD, 36));
            if (MainWindow.turn % 2 == 0) p1.setX(p32); //Player 1 turn
            if (MainWindow.turn % 2 != 0) p2.set0(p32); //Player 2 turn
            turn++; // switch turn
        ...
        p33.addActionListener(actionEvent -> {
            p33.setFont(new Font("Times", Font.BOLD, 36));
            if (MainWindow.turn % 2 == 0) p1.setX(p33); //Player 1 turn
            if (MainWindow.turn % 2 != 0) p2.set0(p33);
            turn++;
        ...
        Color myBlue = new Color(176, 196, 222);
